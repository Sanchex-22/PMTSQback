...
async function main() {
  ...
  // --- PASO 1: Eliminar registros de tablas dependientes PRIMERO ---
  // Esto es necesario para cumplir con las restricciones de clave foránea.
  // Borramos las cotizaciones y evaluaciones antes de borrar los cursos e instructores.
  await prisma.quote.deleteMany({});
  console.log(`Registros de cotizaciones existentes eliminados.`);

  await prisma.evaluation.deleteMany({}); // Asumiendo que también quieres limpiar las evaluaciones
  console.log(`Registros de evaluaciones existentes eliminados.`);


  // --- PASO 2: Ahora sí, eliminar los registros de las tablas principales ---
  ...
  // --- PASO 3: Sembrar los nuevos datos ---
  ...
  for (const courseData of courses) {
    const course = await prisma.course.create({
      data: {
        ...
        price_panamanian_renewal: courseData.price_panamanian_renewal ?? undefined,
